...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Test failed with Assert.AreEqual failed. Expected:<Bob>. Actual:<Sue>. The queue was implemented as a stack (LIFO) instead of a queue (FIFO), causing wrong order.
    ...
    // Defect(s) Found: Test failed with Assert.AreEqual failed. Expected:<Tim>. Actual:<Sue>. The queue was implemented as a stack (LIFO) instead of a queue (FIFO), causing wrong order.
