...
public static class SetsAndMaps
{
    ...
    public static string[] FindPairs(string[] words)
    {
        ...
        foreach (var word in words)
        {
            ...
            var revPair = (word[1], word[0]);
            if (seen.Contains(revPair))
            {
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        foreach (char c in clean1) counts[c] = counts.GetValueOrDefault(c, 0) + 1;
        foreach (char c in clean2) counts[c] = counts.GetValueOrDefault(c, 0) - 1;
